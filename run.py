...
print("Tapa trasera maletero: %s" % str(margin_05((WIDTH, TRUNK_HEIGHT))))
print("Tapas laterales maletero 2x: %s" % str(margin_05((DEEP - WRAPPER_WOOD_WIDTH, TRUNK_HEIGHT))))

ancho_izquierda_abajo = LEFT_FRAME + NEEDED_GAP_LEFT
ancho_derecha_abajo = WIDTH - (LEFT_FRAME + NEEDED_GAP_LEFT + INTERIOR_WOOD_WIDTH)
